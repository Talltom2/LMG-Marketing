...
export default async function DiagnosticsPage(){
 const report=await runDiagnosticEngine(7); let walmartNative:any=null;let wooNative:any=null;let pinterestNative:any=null;
 ...
 try { pinterestNative=await getPinterestConfigHealth(); } catch {}
 const actionable=report.findings.filter(f=>f.severity!=="HEALTHY"&&!/pinterest/i.test(f.channelName));
 const pinterestSeverity=(pinterestNative?.health==="RED"?"CRITICAL":pinterestNative?.health==="GREEN"?"HEALTHY":"WARNING") as DiagnosticSeverity;
